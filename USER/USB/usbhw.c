...
extern uint32_t   HOST_RhscIntr ;         /* Root Hub Status Change interrupt                       */
extern uint32_t   HOST_WdhIntr  ;         /* Semaphore to wait until the TD is submitted            */
extern uint32_t   HOST_TDControlStatus ;
/*
